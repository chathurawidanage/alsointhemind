    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div id="master" className="py-20 px-4 bg-white text-center scroll-mt-16">
                ...
                <div className="max-w-[1024px] mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
                    {/* Mobile: Round Avatar */}
                    <Avatar
                        src={monk1.src}
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        <h3 className={`text-4xl md:text-5xl font-bold mb-6 text-gray-900 ${leagueSpartan.className}`}>Venerable Ñānavimala Mahāthera</h3>

                        <div className="text-gray-600 text-lg md:text-xl space-y-6 leading-relaxed">
                            <p>
